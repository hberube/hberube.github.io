...
msg['Subject'] = "Pool a Hugo 2017: Votre rapport hebdomadaire!"
msg['From'] = me
msg['To'] = you
            ...
            <table style="width: 80%">
            	<tbody>
            		<tr>
            			<td>
            				<center>
            					<a href="http://lepoolahugo.com"><img src="https://dl.dropboxusercontent.com/u/1217226/Pool_BerubeRoy_2017/img/pool-bg.png" style="width:100%"></a>
            					<i>(Cliquez sur la banni&egrave;re pour acc&eacute;der au site.)</i>
            					<br> %s
            				</center>
            			</td>
            		</tr>
            		<tr>
            			<td>
            				<center>
            				<p style="color: #000000; font-weight: normal;letter-spacing: 2pt;word-spacing: 2.5pt;font-size: 1.5em;text-align: left;font-family: Verdana, sans-serif; line-height: 1; vertical-align: middle;">
            		...
            		<tr class="leadersScores img-rounded">
            			<td>
            				...
            				<table>
            					<tr>
            						<td colspan="2">
            							<p style="color: #fff; background-color: #337ab7;font-weight: normal;letter-spacing: 2pt;word-spacing: 2.5pt;font-size: 1.9em;text-align: left;font-family: Verdana, sans-serif; line-height: 1; vertical-align: middle; text-align:center">
            							The Champs
            							</p>	
            						</td>
            					</tr>
            					<tr>
	                				...
	                				<td class="img-rounded bg-success ng-binding" style="width: 40%;">
	                					<p style="color: #000000; font-weight: normal;letter-spacing: 2pt;word-spacing: 2.5pt;font-size: 1.25em;text-align: left;font-family: Verdana, sans-serif; line-height: 1; vertical-align: middle;">
	                						<b>B:</b> 403&nbsp;[+0]<br><br>
	                						<b>P:</b> 632&nbsp;[+0]<br><br>
	                						<b>W:</b> 62&nbsp;[+0]<br><br>
	                						<b>SO:</b> 9&nbsp;[+0]<br><br>
